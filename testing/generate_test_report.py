...
def build_run_commands_sheet(wb):
    ...
    commands = [
        ...
        ("All tests",                 "cd testing && pytest api/ unit/ selenium/ functional/ --tb=short -v --junitxml=reports/master_junit.xml", ""),
        ...
        ("Selenium web tests",        "pytest testing/selenium/test_selenium_web.py -v --junitxml=testing/reports/selenium_junit.xml", ""),
        ("Functional E2E tests",      "pytest testing/functional/test_functionality.py -v --junitxml=testing/reports/functional_junit.xml", ""),
        ("Appium mobile tests",       "pytest testing/appium/test_appium_mobile.py -v --junitxml=testing/reports/mobile_junit.xml", ""),
...
def generate_report(
    ...
    full_path = out_dir / f"E2E_Test_Report_PancreaScan_{ts}.xlsx"
    wb = Workbook()
